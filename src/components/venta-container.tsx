...
export function VentaContainer() {
  ...
  const [carrito, setCarrito] = useState<{ producto: Producto; cantidad: number; precio: number }[]>([])
  ...
  const handleAddToCart = (producto: Producto, cantidad: number, precio: number) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div>
        <CarritoVenta
          items={carrito}
          sucursal={sucursales.find((s) => s.id.toString() === selectedSucursal)}
